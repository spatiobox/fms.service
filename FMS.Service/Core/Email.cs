    ...
    public class EmailHelper
    {
        ...
        public string SmtpHost
        {
            get
            {
                ...
                {
                    _SmtpHost = ConfigurationManager.AppSettings["SmtpServer"];
                }
                return _SmtpHost;
            }
        }
        ...
        public string FromEmailAddress
        {
            get
            {
                ...
                {
                    _FromEmailAddress = ConfigurationManager.AppSettings["SmtpUser"];
                }
        ...
        public string FromEmailName
        {
            get
            {
                ...
                {
                    //_FromEmailName = this.FromEmailAddress.Substring(0, this.FromEmailAddress.IndexOf("@"));
                    _FromEmailName = "配料系统(Formula)";
                }
        ...
        public string FormEmailPassword
        {
            get
            {
                ...
                {
                    _FormEmailPassword = ConfigurationManager.AppSettings["SmtpPwd"];
                }
        ...
        public void Send()
        {
            ...
            mm.From = new MailAddress(this.FromEmailAddress, this.FromEmailName, Encoding.GetEncoding(936));
